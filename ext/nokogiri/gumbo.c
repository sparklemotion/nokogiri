 ...
 */
static VALUE
rb_gumbo_s_parse(int argc, VALUE *argv, VALUE _self)
{
 ...
 */
static VALUE
rb_gumbo_s_fragment(int argc, VALUE *argv, VALUE _self)
{
  VALUE doc_fragment;
  VALUE tags;
  VALUE ctx;
...
noko_init_gumbo(void)
{
  ...
  rb_define_singleton_method(mNokogiriGumbo, "parse", rb_gumbo_s_parse, -1);
  rb_define_singleton_method(mNokogiriGumbo, "fragment", rb_gumbo_s_fragment, -1);
}
