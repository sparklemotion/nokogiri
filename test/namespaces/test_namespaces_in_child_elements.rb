...
describe 'namespaces in child elements' do
  ...
  describe 'default namespaces' do
    it 'properly handles default namespaces' do
      ...
      assert_includes(doc, '<specific:child xmlns:specific="http://specific-namespace.org/">with specific namespace</specific:child>')
    end
