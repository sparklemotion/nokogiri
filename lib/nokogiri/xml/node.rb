...
module Nokogiri
  module XML
    ...
    class Node
      ...
      ###
      # A Hash version of #namespace_scopes. Returns namespaces in scope for
      # self -- those defined on self element directly or any ancestor node --
      # as a Hash of attribute-name/value pairs. Note that the keys in this hash
      # XML attributes that would be used to define this namespace, such as
      # "xmlns:prefix", not just the prefix. Default namespace set on self will
      # be included with key "xmlns". However, default namespaces set on
      # ancestor will NOT be, even if self has no explicit default namespace.
      def namespaces
