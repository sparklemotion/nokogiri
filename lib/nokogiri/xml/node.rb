...
module Nokogiri
  module XML
    ...
    class Node
      ...
      #   dst_node = dst_doc.at_xpath('//foo')               # Node to place it after.
      #   # Before the move.
