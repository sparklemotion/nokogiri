...
* [CRuby] The CSS `~=` operator and class selector `.` are about 2x faster. [[#2133](https://github.com/sparklemotion/nokogiri/issues/2133), [#2135](https://github.com/sparklemotion/nokogiri/issues/2135)]
